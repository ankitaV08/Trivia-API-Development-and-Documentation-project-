...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_questions_categorywise(self):
    ...
    def test_get_questions_categorywise_not_found(self):
        res = self.client().get('/categories/54/questions')
        data = json.loads(res.data)
